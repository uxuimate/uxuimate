...
const CinematicEscapesHeroSlider = () => (
    ...
    >
      {HERO_SLIDES.map((slide, index) => (
        <SwiperSlide key={slide.image}>
          ...
          <img src={slide.image} alt="Cinematic Escapes case study hero" loading={index === 0 ? 'eager' : 'lazy'} sizes="100vw" />
              ...
              <Col xs={12} className="mb-0 mb-md-5">
                <div className="offer-hero__panel reveal-up">
                  ...
                  <div className="video-case-hero__actions">
                    <Link className="btn btn-white btn-rounded btn-large" to="/contact">
                      Contact us →
                    </Link>
...
export default CinematicEscapesHeroSlider;
